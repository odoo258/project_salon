...
class AccountInvoice(models.Model):
    ...
    purchase_origin_id = fields.Many2one('purchase.order','Purchase Order Origin')
    ...
    def purchase_order_change(self):
        ...
        if self.purchase_id.fiscal_position_id:
            self.fiscal_position_id = self.purchase_id.fiscal_position_id.id
        if self.purchase_id.payment_term_id:
            self.payment_term_id = self.purchase_id.payment_term_id.id
        self.purchase_origin_id = self.purchase_id.id
