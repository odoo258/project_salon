...
models.Order = models.Order.extend({
    ...
    get_won_points: function(){
        ...
        if (order){
            if (order.discount_percent > 0){
                var desc = total_points * (order.discount_percent/100);
                total_points = round_pr(total_points - desc, rounding );
            }
            if (order.discount_total > 0){
                total_points = round_pr(total_points - order.discount_total, rounding );
            }
        }
        return total_points;
    },
    ...
    export_as_JSON: function(){
        ...
        json.points_spend = this.get_spent_points();
        return json;
    },
});
    ...
    button_click: function(){
        ...
        if (rewards.length === 0) {
            ...
            this.gui.show_popup('selection',{
                'title': 'Por favor selecione a recompensa',
                'list': list,
