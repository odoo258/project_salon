...
class AccountConfigSettings(models.TransientModel):
    ...
    sepa_initiating_party_name = fields.Char(related='company_id.sepa_initiating_party_name', string="Your Company Name *", help="Etherpad lite server. Example: beta.primarypad.com")
