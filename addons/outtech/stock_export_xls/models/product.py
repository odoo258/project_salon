...
class Product(models.Model):
    ...
    @api.multi
    def _compute_quantities_dict_by_location(self, location_id, warehouse, lot_id, owner_id, package_id, from_date=False, to_date=False):
        ...
        if location_id:
            domain_quant += [('location_id', 'in', location_id)]
        if warehouse:
            domain_quant += [('negative_move_id.warehouse_id', '=' ,warehouse)]
