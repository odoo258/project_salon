...
##############################################################################
{
    ...
    "category": "Industries",
    'depends': ['base', 'account', 'mail', 'website', 'product'],
    'data': ['views/salon_security.xml',
             ...
             'views/salon_professional_view.xml',
             'views/salon_promotion_view.xml',
             'views/salon_promotiongroup_view.xml',
