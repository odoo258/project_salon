...
class PosInvoiceReportNew(models.AbstractModel):
...
class POSInvoiceTotalDisc(models.Model):
    ...
    def _compute_amount(self):
        ...
        self.amount_total = self.total_bruto - self.total_desconto + self.total_tax + self.total_frete + self.total_seguro + self.total_despesas
