odoo.define('vehicle_service.payment', function (require) {
"use strict";
...
$(document).ready(function () {
    ...
    $payment.on("click", 'button[type="submit"], button[name="submit"]', function (ev) {
      ...
      //waitingDialog.show('Processando Pagamento', {dialogSize: 'sm', progressType: 'warning'});
      alert("Permitir Tentativa de Pagamento");
      if (! acquirer_id) {
        return false;
      }
      if (acquirer_token) {
