...
: ${SATCFE_TEST_LIB:/BematechFiscal/SAT/app/native-api/Tanca/libsat.so}
#?"Defina SATCFE_TEST_LIB apontando para a biblioteca SAT"}
: ${SATCFE_TEST_LIB_CONVENCAO:'1'}
#?"Defina SATCFE_TEST_LIB_CONVENCAO conforme convenção de chamada para a biblioteca SAT"}
: ${SATCFE_TEST_CODIGO_ATIVACAO:123456789}
#?"Defina SATCFE_TEST_CODIGO_ATIVACAO com o código de ativação do equipamento SAT"}
: ${SATCFE_TEST_UF:SP}
#?"Defina SATCFE_TEST_UF com a sigla do Estado do domicílio fiscal do equipamento SAT"}
